...
map("n", "<c-z>", ":u<CR>", { desc = "Undo", remap = true })
map("n", "<c-y>", ":redo<CR>", { desc = "redo", remap = true })
map("i", "", "<C-o>:u<CR>", { desc = "Undo", remap = true })
map("i", "<80>ü^DY", "<C-o>:redo<CR>", { desc = "redo", remap = true })
...
map("n", "<a-3>", function() Util.float_term() end, { desc = "Terminal (cwd)" })
map("n", "<a-1>", lazyterm, { desc = "Terminal (root dir)" })
...
map("t", "<A-3>", "<cmd>close<cr>", { desc = "Hide Terminal" })
