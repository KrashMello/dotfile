...
__groups = {
    ...
    4: Group(" 󰵮  ", layout="monadtall", layouts=layouts, matches=[Match(wm_class=["insomnia", "Insomnia","postman", "Postman","qutebrowser", "qutebrowser"])]),
    5: Group("   ", layout="monadwide", layouts=layouts_maxtowide, matches=[Match(wm_class=["docker desktop", "Docker Desktop","github desktop", "GitHub Desktop","DBeaver", "DBeaver", "beekeeper-studio",])]),
    ...
    8: Group(" 󰊗  ", layout="monadwide", layouts=layouts_maxtowide, matches=[Match(wm_class=["steam","game.exe", "mtga.exe"])]),
    9: Group("   ",layout="monadwide", layouts=layouts_maxtowide, matches=[Match(wm_class=["qtpad","Notes","slack", "Slack","notion-app", "notion-app","telegram-desktop", "TelegramDesktop","whatsapp-nativefier-d40211", "whatsapp-nativefier-d40211","franz", "Franz"])]),
